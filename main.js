...
function car1_up(){
    ...
    {
        car1Y = car1Y - 10;
        console.log("Quando a seta para cima for prescionada, x = " + car1X + "| y = " +car1Y);
        uploadBackground();
        uploadcar1();
    }
  }
  ...
  function car1_down(){
    ...
    {
        car1Y =car1Y + 10;
        console.log("Quando a seta para baixo for prescionada, x = " + car1X + "| y = " + car1Y);
        uploadBackground();
        uploadcar1();
    }
}   
    ...
    if(car1X >=0){
        car1X = car1X - 10;
        console.log("Quando a seta para esquerda for prescionada, x = " + car1X + "| y = " +car1Y);
        uploadBackground();
        uploadcar1();
    }
}
...
function car1_right() {
    if(car1X <=700){
        car1X = car1X + 10;
        console.log("Quando a seta para direita for prescionada, x = " + car1X + "| y = " +car1Y);
        uploadBackground();
        uploadcar1();
    }
}
...
function car2_up(){
    ...
    {
        car2Y = car2Y - 10;
        console.log("Quando a tecla W for prescionada, x = " + car2X + "| y = " +car2Y);
        uploadBackground();
        uploadcar2();
    }
  }
  ...
  function car2_down(){
    ...
    {
        car2Y =car2Y + 10;
        console.log("Quando a tecla S for prescionada, x = " + car2X + "| y = " + car2Y);
        uploadBackground();
        uploadcar2();
    }
}   
    ...
    if(car2X >=0){
        car2X = car2X - 10;
        console.log("Quando a tecla D for prescionada, x = " + car2X + "| y = " +car2Y);
        uploadBackground();
        uploadcar2();
    }
}
...
function car2_right() {
    if(car2X <=700){
        car2X = car2X + 10;
        console.log("Quando a tecla A for prescionada, x = " + car2X + "| y = " +car2Y);
        uploadBackground();
        uploadcar2();
    }
}
